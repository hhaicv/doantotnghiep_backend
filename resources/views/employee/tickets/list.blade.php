        ...
        <div class="col-lg-12">
            <div class="card" id="orderList">
                    ...
                    <div class="row align-items-center gy-3">
                        ...
                        <div class="col-sm-auto">
                            <div class="d-flex gap-1 flex-wrap">
                                <a href="{{ route('employee.tickets') }}"><button type="button"
                ...
                <div class="card-body border border-dashed border-end-0 border-start-0">
                    <form method="GET" action="{{ route('employee.ticket_list') }}">
                        @csrf
                        <div class="row g-3">
                            ...
                            <div class="col-xxl-2 col-sm-4">
                                ...
                                <div class="row g-3">
                                    <div class="col">
                                        ...
                                        <div class="mb-2">
                                            <a href="{{ route('employee.ticket_list') }}" class="btn btn-primary w-100">Hủy
                                                lọc</a>
                                        </div>
                                    </div>
                                    <div class="col">
                                            ...
                                            <td>
                                                <ul class="list-inline hstack gap-2 mb-0">
                                                    ...
                                                    @if ($bookingDate->greaterThan($currentDate) && $ticketBooking->status == App\Models\TicketBooking::PAYMENT_STATUS_PAID)
                                                        <li class="list-inline-item" data-bs-toggle="tooltip">
                                                            <a href="{{ route('employee.tickets_change', $ticketBooking->id) }}"
                                                                class="text-primary">
