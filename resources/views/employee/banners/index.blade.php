        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    ...
                    <a class="btn btn-primary mb-3" href="{{ route('employee.banners.create') }}">Thêm mới Banner</a>
                </div>
                <div class="card-body">
                    <table id="example" class="table table-bordered dt-responsive nowrap table-striped align-middle"
                        ...
                        <tbody>
                            @foreach ($data as $item)
                                <tr>
                                    <td>{{ $item->id }}</td>
                                    <td><img src="{{ Storage::url($item->image_url) }}" alt="" width="150px"
                                            height="100px"></td>
                                    ...
                                    <td>
                                        <div class="hstack gap-3 fs-15">
                                            <a href="{{ route('employee.banners.edit', $item->id) }}" class="link-primary"><i
                                                    class="ri-settings-4-line"></i></a>
                                            <form id="deleteFormBanner{{ $item->id }}"
                                                action="{{ route('employee.banners.destroy', $item->id) }}" method="post">
                                                @csrf
                                                @method('DELETE')
