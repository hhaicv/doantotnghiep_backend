                        ...
                        <table class="table table-nowrap align-middle" id="orderTable">
                            ...
                            <tbody class="list form-check-all">
                                ...
                                <tr>
                                    ...
                                    <td class="total_price text-center">{{ number_format($ticketBooking->total_price, 0, ',', '.') }} ₫</td>
                                    <td class="payment">{{ $ticketBooking->paymentMethod->name }}</td>
                                    <td class="status text-center">
                                        <span class="badge bg-warning-subtle text-warning text-uppercase">{{ $ticketBooking->status }}</span>
                                    </td>
                                    <td>
                                        <ul class="list-inline hstack gap-2 mb-0">
                                            <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="View">
                                                <a href="{{ route('admin.tickets.show', $ticketBooking->id) }}" class="text-primary d-inline-block">
                                                    <i class="ri-eye-fill fs-16"></i>
                                                </a>
                                            </li>
                                            <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Remove">
                                                <a class="text-danger d-inline-block remove-item-btn" data-id="{{ $ticketBooking->id }}" href="javascript:void(0);">
