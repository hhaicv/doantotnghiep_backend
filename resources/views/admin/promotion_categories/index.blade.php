        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    ...
                    <a class="btn btn-primary mb-3" href="{{ route('admin.promotion_categories.create') }}">Thêm mới  danh mục khuyến mãi</a>
                </div>
                <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="hstack gap-3 fs-15">
                                            <a href="{{ route('admin.promotion_categories.edit', $item->id) }}"
                                                class="link-primary"><i class="ri-settings-4-line"></i></a>
                                            <form id="deleteFormPromotion{{ $item->id }}"
                                                action="{{ route('admin.promotion_categories.destroy', $item->id) }}"
                                                method="post">
                                                @csrf
                                                @method('DELETE')
