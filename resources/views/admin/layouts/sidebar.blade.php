    ...
    <div id="scrollbar">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item {{ Request::routeIs(['admin.tickets.index','admin.ticket_list','admin.tickets.create','admin.tickets.show']) ? 'active' : '' }}">
                ...
                <li class="nav-item {{ Request::routeIs(['admin.new_categories.index','admin.information.index']) ? 'active' : '' }}">
                ...
                <li class="nav-item {{ Request::routeIs(['admin.banners.index','admin.banners.create']) ? 'active' : '' }}">
                ...
                <li class="nav-item {{ Request::routeIs(['admin.promotion_categories.index','admin.promotions.index']) ? 'active' : '' }}">
                ...
                <li class="nav-item {{ Request::routeIs(['admin.contacts.index','admin.contacts.create']) ? 'active' : '' }}">
                ...
                <li class="nav-item {{ Request::routeIs(['admin.admins.index','admin.users.employees','admin.drivers.index','admin.users.customers']) ? 'active' : '' }}">
                ...
                <li class="nav-item {{ Request::routeIs(['admin.statistics.tripStatistical']) ? 'active' : '' }}">
