                ...
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-shrink-0">
                            <a href="<?php echo e(route('employee.tickets', $showTicket->id)); ?>" class="btn btn-success btn-sm"><i
...
<?php $__env->startSection('script-libs'); ?>
    ...
    <script src="<?php echo e(asset('theme/employee/assets/js/pages/plugins/lord-icon-2.1.0.js')); ?>"></script>
    <script src="<?php echo e(asset('theme/employee/assets/js/plugins.js')); ?>"></script>

    <!-- list.js min js -->
    <script src="<?php echo e(asset('theme/employee/assets/libs/list.js/list.min.js')); ?>"></script>

    <!--list pagination js-->
    <script src="<?php echo e(asset('theme/employee/assets/libs/list.pagination.js/list.pagination.min.js')); ?>"></script>

    <!-- ecommerce-order init js -->
    <script src="<?php echo e(asset('theme/employee/assets/js/pages/ecommerce-order.init.js')); ?>"></script>

    <script src="<?php echo e(asset('theme/employee/assets/libs/sweetalert2/sweetalert2.min.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('employee.layouts.mater', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH L:\laragon\www\doantotnghiep\resources\views/employee/tickets/show.blade.php ENDPATH**/ ?>