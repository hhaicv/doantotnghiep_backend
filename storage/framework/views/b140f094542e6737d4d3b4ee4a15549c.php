...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card">
        <form action="<?php echo e(route('employee.promotions.update', $data->id)); ?>" method="POST" class="row g-3 p-5" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-12 text-end">
                ...
                <a href="<?php echo e(route('employee.promotions')); ?>" class="btn btn-success">Quay lại</a>
            </div>
        </form>
    </div>
<?php $__env->stopSection(); ?>
...
<?php echo $__env->make('employee.layouts.mater', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH L:\laragon\www\doantotnghiep\resources\views/employee/promotions/edit.blade.php ENDPATH**/ ?>