                ...
                <div class="file-drop-area" id="file-drop-area">
                    ...
                    <div id="file-preview">
                        <?php if($model->image_url): ?>
                            <img src="<?php echo e(Storage::url($model->image_url)); ?>" alt="Ảnh đã tải lên" width="200px" height="150px">
                        <?php endif; ?>
                    </div>
                </div>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-md-6">
                ...
                <input type="date" name="start_date" id="start_date" class="form-control"
                    value="<?php echo e(old('start_date', $model->start_date)); ?>">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-md-6">
                ...
                <input type="date" name="end_date" id="end_date" class="form-control"
                    value="<?php echo e(old('end_date', $model->end_date)); ?>">
...
<?php echo $__env->make('admin.layouts.mater', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\doantotnghiep\resources\views/admin/banners/edit.blade.php ENDPATH**/ ?>