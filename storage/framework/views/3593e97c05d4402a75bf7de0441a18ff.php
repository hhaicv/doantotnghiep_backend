        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <h5 class="card-title mb-0">Danh sách tài xế</h5>
                    <a class="btn btn-primary mb-3" href="<?php echo e(route('admin.drivers.create')); ?>">Thêm mới tài xế</a>
                </div>
                <div class="card-body">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><img width="100px" height="70px" src="<?php echo e(Storage::url($item->profile_image)); ?>"
                                            alt="Hình tài xế"></td>
                                    ...
                                    <td>
                                        <div class="hstack gap-3 fs-15">
                                            <a href="<?php echo e(route('admin.drivers.show', $item->id)); ?>" class="link-primary"><i
                                                    class="ri-file-paper-2-fill"></i></a>
                                            <a href="<?php echo e(route('admin.drivers.edit', $item->id)); ?>" class="link-primary"><i
                                                    class="ri-settings-4-line"></i></a>
                                            <form id="deleteFormDriver<?php echo e($item->id); ?>"
                                                action="<?php echo e(route('admin.drivers.destroy', $item->id)); ?>" method="post">
                                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.mater', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH L:\laragon\www\doantotnghiep\resources\views/admin/drivers/index.blade.php ENDPATH**/ ?>