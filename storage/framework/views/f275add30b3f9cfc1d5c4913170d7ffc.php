            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarExecutive">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="<?php echo e(route('employee.buses.index')); ?>" class="nav-link" data-key="t-buses">Danh
                                    sách xe</a>
                            </li>
                            
                            <li class="nav-item">
                                <a href="<?php echo e(route('employee.stops.index')); ?>" class="nav-link" data-key="t-stops">Điểm
                                    dừng</a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('employee.routes.index')); ?>" class="nav-link" data-key="t-routes">Tuyến
                                    đường</a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('employee.trips.index')); ?>" class="nav-link" data-key="t-trips">Danh sách chuyến</a>
                            </li>
                        </ul>
                    </div>
                </li>
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarTickets">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="<?php echo e(route('employee.tickets.index')); ?>" class="nav-link"
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarPromotion">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="<?php echo e(route('employee.promotions.index')); ?>" class="nav-link"
                                    data-key="t-horizontal">Danh sách</a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('employee.promotions.create')); ?>" class="nav-link"
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarReviews">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="<?php echo e(route('employee.reviews.index')); ?>" class="nav-link"
                                    data-key="t-horizontal">Danh sách</a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('employee.reviews.create')); ?>" class="nav-link"
                                    data-key="t-horizontal">Thêm mới</a>
                            </li>
                        </ul>
                    </div>
...
<!-- Left Sidebar End --><?php /**PATH D:\laragon\www\doantotnghiep\resources\views/employee/layouts/sidebar.blade.php ENDPATH**/ ?>