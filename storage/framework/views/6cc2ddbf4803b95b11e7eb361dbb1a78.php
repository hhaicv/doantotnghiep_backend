                        ...
                        <div class="card-header border-bottom-dashed p-4">
                            <div class="d-flex">
                                <div class="flex-grow-1">
                                    <img src="<?php echo e(asset('theme/admin/assets/images/logo-removebg-preview.png')); ?>" class="card-logo card-logo-dark" alt="logo dark" height="120">
                                    <img src="<?php echo e(asset('theme/admin/assets/images/logo-removebg-preview.png')); ?>" class="card-logo card-logo-light" alt="logo light" height="120">
                        ...
                        <div class="card-body p-4">
                            <div class="row g-3">
                                <div class="col-lg-3 col-6">
                                    ...
                                    <h5 class="fs-14 mb-0">#<span id="invoice-no"><?php echo e($showPayment->order_code); ?></span></h5>
                                </div>
                                <!--end col-->
                                <div class="col-lg-3 col-6">
                                    <p class="text-muted mb-2 text-uppercase fw-semibold">Thời gian</p>
                                    <h5 class="fs-14 mb-0"><span id="invoice-date"><?php echo e($showPayment->created_at); ?></span> </h5>
                                </div>
                                <!--end col-->
                                <div class="col-lg-3 col-6">
                                    <p class="text-muted mb-2 text-uppercase fw-semibold">Trạng thái thanh toán</p>
                                    <span class="badge bg-success-subtle text-success fs-11" id="payment-status"><?php echo e($showPayment->status); ?></span>
                                </div>
                                <!--end col-->
                                <div class="col-lg-3 col-6">
                                    <p class="text-muted mb-2 text-uppercase fw-semibold">Tổng tiền</p>
                                    <h5 class="fs-14 mb-0"><span id="total-amount"><?php echo e(number_format($showPayment->total_price, 0, ',', '.')); ?> VNĐ</span></h5>
                                </div>
                                <!--end col-->
                            </div>
                            <!--end row-->
                        ...
                        <div class="card-body p-4 border-top border-top-dashed">
                            <div class="row g-3">
                                <div class="col-6">
                                    ...
                                    <p class="fw-medium mb-2" id="billing-name"><?php echo e($showPayment->name); ?></p>
                                    <p class="text-muted mb-1" id="billing-address-line-1">Hà Nội-Việt Nam</p>
                                    <p class="text-muted mb-1"><span>Số điện thoại: +</span><span id="billing-phone-no">(84) <?php echo e($showPayment->phone); ?></span></p>
                        ...
                        <div class="card-body p-4">
                            <div class="table-responsive">
                                <table class="table table-borderless text-center table-nowrap align-middle mb-0">
                                    ...
                                    <?php $__currentLoopData = $showPayment->ticketDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ticketDetail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td class="text-end"><?php echo e($ticketDetail->id); ?> </td>
                                            <td>
                                                <div class="d-flex">
                                ...
                                <table class="table table-borderless table-nowrap align-middle mb-0 ms-auto" style="width:250px">
                                    <tbody>
                                        <tr class="border-top border-top-dashed fs-15">
                                            ...
                                            <th class="text-end"><?php echo e(number_format($showPayment->total_price, 0, ',', '.')); ?> VNĐ</th>
                                        </tr>
                                    </tbody>
                                </table>
                                <!--end table-->
                            ...
                            <div class="mt-3">
                                ...
                                <p class="text-muted mb-1">Phương thức thanh toán: <span class="fw-medium" id="payment-method">
                                        <?php if($showPayment->payment_method_id == 1): ?>
                                            Tại quầy
                                        <?php elseif($showPayment->payment_method_id == 2): ?>
                                            MoMoPay
                                        <?php elseif($showPayment->payment_method_id == 3): ?>
                                            VNPay
                                        <?php else: ?>
                                            Không xác định
                                        <?php endif; ?></span></p>
                                <p class="text-muted">Tổng tiền: <span id="card-total-amount"><?php echo e(number_format($showPayment->total_price, 0, ',', '.')); ?> VNĐ</span></p>
                            </div>
                            <div class="mt-4">
...
<?php echo $__env->make('admin.layouts.mater', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\doantotnghiep\resources\views/admin/tickets/edit.blade.php ENDPATH**/ ?>