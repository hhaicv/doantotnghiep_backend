        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    ...
                    <a class="btn btn-primary mb-3" href="<?php echo e(route('admin.routes.create')); ?>">Thêm mới</a>
                </div>
                <div class="card-body">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><?php echo e($item->vehicle_count); ?> Xe</td>
                                    ...
                                    <td>
                                        <div class="hstack gap-3 fs-15">
                                            <a href="<?php echo e(route('admin.routes.edit', $item->id)); ?>" class="link-primary"><i
                                                    class="ri-settings-4-line"></i></a>
                                            <form id="deleteFormRoute<?php echo e($item->id); ?>"
                                                action="<?php echo e(route('admin.routes.destroy', $item->id)); ?>" method="post">
                                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.mater', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\doantotnghiep\resources\views/admin/routess/index.blade.php ENDPATH**/ ?>