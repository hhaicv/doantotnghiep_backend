...
<?php $__env->startSection('content'); ?>
    ...
    <form id="createproduct-form" autocomplete="off" class="needs-validation" novalidate
        action="<?php echo e(route('admin.routes.store')); ?>" method="POST">
        <?php echo csrf_field(); ?>
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
...
<?php echo $__env->make('admin.layouts.mater', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\doantotnghiep\resources\views/admin/routess/create.blade.php ENDPATH**/ ?>