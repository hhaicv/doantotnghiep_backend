                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div class="flex-grow-1 overflow-hidden">
                                    <p class="text-uppercase fw-medium text-muted text-truncate mb-0"><?php echo e($stat['label']); ?></p>
                                </div>
                            </div>
                            <div class="d-flex align-items-end justify-content-between mt-4">
                                <div>
                                    <h4 class="fs-22 fw-semibold ff-secondary mb-4">
                                        <span>
                                            <?php if($stat['label'] == 'Tổng doanh thu'): ?>
                                            <?php echo e($stat['value']); ?> VNĐ
                                            <?php else: ?>
                                    ...
                                    <a href="<?php echo e($stat['route']); ?>" class="text-decoration-underline">Xem chi
                                        tiết</a>
                                </div>
                                <div class="avatar-sm flex-shrink-0">
                                    <span class="avatar-title bg-success-subtle rounded fs-3">
                                        <!-- Thêm màu xanh cho icon của "Tổng xe" -->
                                        <?php if($stat['label'] == 'Tổng xe'): ?>
                                        <i class="fas fa-bus text-success"></i> <!-- Màu xanh cho icon xe buýt -->
                                        <?php else: ?>
                                        <i class="bx <?php echo e($stat['icon']); ?> text-success"></i>
                                        <?php endif; ?>
                                    </span>
                                </div>
                            </div>
                            ...
                            <div class="row g-0 text-center">
                                <div class="col-6 col-sm-3">
                                    <div class="p-3 border border-dashed border-start-0">
                                        <h5 class="mb-1"><span><?php echo e($totalTickets); ?></span></h5>
                                ...
                                <div class="col-6 col-sm-3">
                                    <div class="p-3 border border-dashed border-start-0">
                                        <h5 class="mb-1">
                                            <span><?php echo e(number_format($totalRevenue, 0, ',', '.')); ?></span> VNĐ
                                        </h5>
...
<script>
    ...
    var monthlyData = <?php echo json_encode($monthlyData, 15, 512) ?>;
    ...
    var topRoutes = <?php echo json_encode($topRoutes, 15, 512) ?>;
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('employee.layouts.mater', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH L:\laragon\www\doantotnghiep\resources\views/employee/dashboard.blade.php ENDPATH**/ ?>