            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown"
                        ...
                        <span class="d-flex align-items-center">
                            <img class="rounded-circle header-profile-user"
                                src="<?php echo e(Auth::guard('admin')->check() && Auth::guard('admin')->user()->image ? Storage::url(Auth::guard('admin')->user()->image) : asset('images/default-avatar.png')); ?>"
                                alt="Header Avatar">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <form id="logout-form" method="POST" action="<?php echo e(route('admin.logout')); ?>"
                            style="display: none;">
                            <?php echo csrf_field(); ?>
                        </form>
...
<?php /**PATH D:\laragon\www\doantotnghiep\resources\views/admin/layouts/header.blade.php ENDPATH**/ ?>