...
<?php $__env->startSection('content'); ?>
    ...
    <?php endif; ?>
    <div class="card">
        <form action="<?php echo e(route('admin.stops.store')); ?>" method="POST" class="row g-3 p-5" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <div class="col-md-6">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-12 text-end">
                ...
                <a href="<?php echo e(route('admin.stops.index')); ?>" class="btn btn-success">Quay lại</a>
            </div>
        </form>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.mater', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH L:\laragon\www\doantotnghiep\resources\views/admin/stops/create.blade.php ENDPATH**/ ?>