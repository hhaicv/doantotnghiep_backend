                            ...
                            <table class="table mb-0 table-borderless">
                                <tbody>
                                    <tr>
                                        ...
                                        <td><?php echo e($data->route->route_name); ?></td>
                                    </tr>
                                    <tr>
                                        <th><span class="fw-medium">Giờ xuất bến</span></th>
                                        <td><?php echo e(\Carbon\Carbon::parse($data->time_start)->format('H:i')); ?> -
                                            <?php echo e($data->date); ?></td>
                                    </tr>
                                    <tr>
                                        <th><span class="fw-medium">Điểm đi</span></th>
                                        <td><?php echo e($startStopName); ?></td>
                                    </tr>
                                    <tr>
                                        <th><span class="fw-medium">Điểm đến</span></th>
                                        <td><?php echo e($endStopName); ?></a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th><span class="fw-medium">Vị trí ghế</span></th>
                                        <td><?php echo e($mergedNameSeats); ?></td>
                                    </tr>
                                    <tr>
                                        <th><span class="fw-medium">Giá</span></th>
                                        <td><?php echo e(number_format($data->total_price, 0, ',', '.')); ?> đ</td>
                                    </tr>
                                    <tr>
...
<?php $__env->startSection('script-libs'); ?>
    <script>
        ...
        function selectSeat(bus_id, route_id, trip_id, route, bus, time_start, totalSeats, fare, date, start_stop_id,
            ...
            window.location.href = `/admin/load?${queryString}`;
        }
...
<?php echo $__env->make('admin.layouts.mater', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\doantotnghiep\resources\views/admin/tickets/change.blade.php ENDPATH**/ ?>