...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card">
        <form action="<?php echo e(route('employee.banners.store')); ?>" method="POST" class="row g-3 p-5" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <div class="col md-6">
                <h5>Hình ảnh</h5>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-12">
                <div class="text-end">
                    ...
                    <a href="<?php echo e(route('employee.banners')); ?>" class="btn btn-success">Quay lại</a>
                </div>
            </div>
        </form>
    </div>
...
<?php echo $__env->make('employee.layouts.mater', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH L:\laragon\www\doantotnghiep\resources\views/employee/banners/create.blade.php ENDPATH**/ ?>