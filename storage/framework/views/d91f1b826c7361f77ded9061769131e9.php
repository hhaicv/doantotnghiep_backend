...
<?php $__env->startSection('content'); ?>
    ...
    <?php endif; ?>
    <div class="card">
        <form action="<?php echo e(route('admin.drivers.update', $data)); ?>" method="POST" class="row g-3 p-5"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-3">
                    ...
                    <input type="date" class="form-control" id="date" name="date_of_birth"
                        value="<?php echo e(old('date_of_birth', \Carbon\Carbon::parse($data->date_of_birth)->format('Y-m-d'))); ?>">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-3 position-relative">
                    ...
                    <input type="password" class="form-control" id="password" name="password" value="<?php echo e(old('password', $data->password)); ?>"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="license_number" name="license_number"
                        value="<?php echo e(old('license_number', $data->license_number)); ?>">
                    ...
                    <div class="file-drop-area" id="file-drop-area">
                        ...
                        <div id="file-preview">
                            <?php if($data->profile_image): ?>
                                <img src="<?php echo e(Storage::url($data->profile_image)); ?>" alt="Ảnh đã tải lên" width="200px"
                                    height="150px">
                            <?php endif; ?>
                        </div>
                    </div>
...
<?php echo $__env->make('admin.layouts.mater', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH L:\laragon\www\doantotnghiep\resources\views/admin/drivers/edit.blade.php ENDPATH**/ ?>