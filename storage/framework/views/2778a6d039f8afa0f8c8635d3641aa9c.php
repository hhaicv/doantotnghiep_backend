        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    ...
                    <a class="btn btn-primary mb-3" href="<?php echo e(route('admin.banners.create')); ?>">Thêm mới Banner</a>
                </div>
                <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="hstack gap-3 fs-15">
                                            <a href="<?php echo e(route('admin.banners.edit', $item->id)); ?>" class="link-primary"><i
                                                    class="ri-settings-4-line"></i></a>
                                            <form id="deleteFormBanner<?php echo e($item->id); ?>"
                                                action="<?php echo e(route('admin.banners.destroy', $item->id)); ?>" method="post">
                                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.mater', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH L:\laragon\www\doantotnghiep\resources\views/admin/banners/index.blade.php ENDPATH**/ ?>