        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    ...
                    <a class="btn btn-primary mb-3" href="<?php echo e(route('admin.promotion_categories.create')); ?>">Thêm mới  danh mục khuyến mãi</a>
                </div>
                <div class="card-body">
                                    ...
                                    <td>
                                        <div class="hstack gap-3 fs-15">
                                            ...
                                            <form id="deleteFormPromotion<?php echo e($item->id); ?>"
                                                action="<?php echo e(route('admin.promotion_categories.destroy', $item->id)); ?>"
                                                method="post">
                                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.mater', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH L:\laragon\www\doantotnghiep\resources\views/admin/promotion_categories/index.blade.php ENDPATH**/ ?>