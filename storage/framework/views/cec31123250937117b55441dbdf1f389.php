        ...
        <form action="<?php echo e(route('admin.banners.store')); ?>" method="POST" class="row g-3 p-5" enctype="multipart/form-data">
            ...
            <div class="col md-6">
                    ...
                    <div class="file-drop-area" id="file-drop-area" >
                        <input type="file" name="image_url" id="file-input" accept="image/*" value="<?php echo e(old('image_url')); ?>" multiple>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" id="link" name="link" placeholder="Gắn link banner" value ="<?php echo e(old('link')); ?>">
