            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="header">
                    <form method="GET" style="display: flex; justify-content-between;"
                        action="<?php echo e(route('driver.drivers.seats')); ?>">
                                ...
                                <div class="tab-pane fade" id="pills-bill-info" role="tabpanel"
                                    ...
                                    <div>
                                        <?php $__currentLoopData = $groupedTrips; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tripId => $trip): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <span class="fs-5" id="time-info"><?php echo e($trip['date']); ?> -
                                                <?php echo e($trip['time_start']); ?></span>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                    <hr>
                                    <div class="mt-4">
                                        <div class="row gy-3">
                                            ...
                                            <?php $__currentLoopData = $groupedTrips; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tripId => $trip): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <input type="hidden" name="date" id="date"
                                                    value="<?php echo e($trip['date']); ?>">
                                                <input type="hidden" name="bus_id" id="bus_id"
                                                    value="<?php echo e($trip['bus_id']); ?>">
                                                <input type="hidden" name="route_id" id="route_id"
                                                    value="<?php echo e($trip['route_id']); ?>">
                                                <input type="hidden" name="time_start" id="time_start"
                                                    value="<?php echo e($trip['time_start']); ?>">
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            <div class="col-4">
                        ...
                        <div class="tab-pane fade" id="pills-bill-address" role="tabpanel"
                            ...
                            <div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="phone" class="form-control"
                                                id="billinginfo-phone" value="<?php echo e(old('phone')); ?>">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="name" class="form-control"
                                                id="billinginfo-name" value="<?php echo e(old('name')); ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" name="note" id="billinginfo-address" rows="3"><?php echo e(old('note')); ?></textarea>
                                </div>
                                <div class="align-items-start gap-3 mt-4">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $groupedTrips; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tripId => $trip): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a
                                                href="<?php echo e(route('driver.drivers.show', ['date' => request()->input('date'), 'trip_id' => $tripId])); ?>">Xem
                                                chi tiết</a>
                                        </td>
                                    </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                if (startStopId && endStopId && tripId) {
                    ...
                    $.ajax({
                        ...
                        data: {
                            ...
                            trip_id: tripId,
                            _token: '<?php echo e(csrf_token()); ?>' // Thêm CSRF token nếu bạn đang sử dụng Laravel
                        },
