    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between">
                ...
                <a class="btn btn-primary mb-3" href="<?php echo e(route('admin.users.create')); ?>">Thêm mới nhân viên</a>
            </div>
            <div class="card-body">
...
<?php echo $__env->make('admin.layouts.mater', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH L:\laragon\www\doantotnghiep\resources\views/admin/users/employees.blade.php ENDPATH**/ ?>