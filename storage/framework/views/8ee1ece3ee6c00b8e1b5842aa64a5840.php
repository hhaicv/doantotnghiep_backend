...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card">
        <form action="<?php echo e(route('admin.information.store')); ?>" method="POST" class="row g-3 p-5" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <div class="row">
                <div class="col md-6">
                    <div class="col mb-3">
                    ...
                    <div class="col md-6">
                        ...
                        <div class="file-drop-area" id="file-drop-area">
                            <input type="file" name="thumbnail_image" id="file-input" accept="image/*"
                                value="<?php echo e(old('thumbnail_image')); ?>" multiple>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-md-6">
                    <div class="col">
                        ...
                        <textarea name="summary" id="editor" placeholder="Tóm tắt ở đây..."><?php echo e(old('summary')); ?></textarea>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="">
                        ...
                        <div class="card-body">
                            <textarea name="content" id="editor1" placeholder=" Nội dung ở đây..."><?php echo e(old('content')); ?></textarea>
                        </div><!-- end card-body -->
...
<?php echo $__env->make('admin.layouts.mater', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH L:\laragon\www\doantotnghiep\resources\views/admin/information/create.blade.php ENDPATH**/ ?>